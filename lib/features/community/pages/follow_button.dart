...
class _FollowButtonState extends State<FollowButton> {
  // Instantiate the service, not FirebaseFirestore directly
  final FollowService _followService = FollowService();
  bool _isLoading = false; // For the button's internal state during toggle
  ...
  Widget build(BuildContext context) {
    ...
    // --- Don't show button for guests (empty currentUserId) ---
    ...
    return StreamBuilder<DocumentSnapshot>(
      // We check our *own* 'following' list to see if the targetId is in it
