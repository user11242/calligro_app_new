...
abstract class AppLocalizations {
  ...
  /// No description provided for @waitingForAdminCommission.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @enrollStudentConfirmMessage.
  ///
  /// In en, this message translates to:
  /// **'Are you sure you want to add {studentName} to \'{courseName}\'?'**
  String enrollStudentConfirmMessage(String studentName, String courseName);

  /// No description provided for @enrollStudentSuccess.
  ///
  /// In en, this message translates to:
